import { Github, Boxes, Code, LineChart, Paintbrush, List, Cpu } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <a href="https://github.com/sfcal/homelab" target="_blank" rel="noopener noreferrer" className="block">
            <div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-xl rounded-2xl p-8 border border-gray-200/50 dark:border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 group cursor-pointer">
              <div className="flex items-center justify-between mb-4">
                ...
                <Github className="w-6 h-6 text-gray-600 dark:text-gray-400 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors" aria-hidden="true" />
              </div>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center text-sm">
                  <Boxes className="w-4 h-4 text-indigo-500 mr-2" aria-hidden="true" />
                  <span>Multi-environment K8s clusters with GitOps</span>
                </div>
                <div className="flex items-center text-sm">
                  <Code className="w-4 h-4 text-purple-500 mr-2" aria-hidden="true" />
                  <span>Terraform, Ansible, and FluxCD automation</span>
                </div>
                <div className="flex items-center text-sm">
                  <LineChart className="w-4 h-4 text-blue-500 mr-2" aria-hidden="true" />
          ...
          <a href="https://github.com/sfcal/gba-resume" target="_blank" rel="noopener noreferrer" className="block">
            <div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-xl rounded-2xl p-8 border border-gray-200/50 dark:border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 group cursor-pointer">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center text-sm">
                  <Paintbrush className="w-4 h-4 text-indigo-500 mr-2" aria-hidden="true" />
                  <span>Custom graphics and animations</span>
                </div>
                <div className="flex items-center text-sm">
                  <List className="w-4 h-4 text-purple-500 mr-2" aria-hidden="true" />
                  <span>Interactive menu system</span>
                </div>
                <div className="flex items-center text-sm">
                  <Cpu className="w-4 h-4 text-blue-500 mr-2" aria-hidden="true" />
